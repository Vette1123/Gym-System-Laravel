    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    <a id="navbarDropdown" class="nav-link dropdown-toggle account" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                        {{ Auth::user()->email }}
                    </a>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{ route('home') }}" class="brand-link text-decoration-none">
                ...
                <span class="brand-text font-weight-light">Sadge Gym</span>
            </a>
            ...
            <div class="sidebar mt-3 p-1">
                ...
                <div class="mt-3 pb-3 mb-3 text-center">
                    <div class="image">
                        <img src="{{asset('/images/users/'.auth()->user()->avatar_image)}}" class="img-circle elevation-2 img-fluid w-25 mx-3" alt="User Image">
                    </div>
